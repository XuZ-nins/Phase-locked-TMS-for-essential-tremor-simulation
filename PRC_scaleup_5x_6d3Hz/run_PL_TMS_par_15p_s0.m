...
if ispc
	copyfile('nrnmech.dll','PL_TMS_par_15p_s0/ET_par_hoc');
else
	system('cp -r x86_64 PL_TMS_par_15p_s0/ET_par_hoc');
end
...
if numCPUs > 1
    ...
    parfor mm = run_range
		if exist(strcat(par_dir,'/PL_TMS_par_15p_s0/simulation_',num2str(mm)),'dir')
			continue;
		end
		...
		mkdir(strcat(par_dir,'/PL_TMS_par_15p_s0/simulation_',num2str(mm),'/recordings_full'));
        system(strcat('cp -r PL_TMS_par_15p_s0/ET_par_hoc/*',' PL_TMS_par_15p_s0/simulation_',num2str(mm),'/'));
        system(strcat('cp -r initialization/currentState.dat PL_TMS_par_15p_s0/simulation_',num2str(mm),'/'));
        system(strcat('cp -r initialization/* PL_TMS_par_15p_s0/simulation_',num2str(mm),'/recordings_full','/'));
		
		cd(strcat(par_dir,'/PL_TMS_par_15p_s0/simulation_',num2str(mm),'/'));
